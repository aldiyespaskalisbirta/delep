...
function Tab() {
  return (
    <div className="z-50 flex gap-4 md:gap-5">
      <Link
        href="https://www.youtube.com/"
        className="flex flex-col items-center justify-center"
      >
        <Card className="w-12 h-12 md:w-16 md:h-16 flex items-center justify-center rounded-full hover:scale-105 transition transform">
